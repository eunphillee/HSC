/**
 * @file modbus_table.c
 * @brief LPSB: Modbus address table - Coil/Discrete from io_map; Holding/Input in RAM.
 */
...
{
    IO_LPSB_ReadAllDiscrete(discrete_image);
}
