...
static const PollEntry_t poll_table[POLL_TABLE_SIZE] = {
    ...
    { SLAVE_ID_HPSB, POLL_ENTRY_READ_INPUT_REG, MODBUS_INPUT_REG_START, 4 },
    /* LPSB1 */
    ...
    { SLAVE_ID_LPSB1, POLL_ENTRY_READ_INPUT_REG, MODBUS_INPUT_REG_START, 2 },
    /* LPSB2 */
    ...
    { SLAVE_ID_LPSB2, POLL_ENTRY_READ_INPUT_REG, MODBUS_INPUT_REG_START, 2 },
    /* LPSB3 */
    ...
    { SLAVE_ID_LPSB3, POLL_ENTRY_READ_INPUT_REG, MODBUS_INPUT_REG_START, 2 },
};
