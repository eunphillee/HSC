...
/* UART1 TTL 디버그 빌드: PC 테스트 Modbus 슬레이브·0xAA 스트림은 사용하지 않음 (USART2는 기존 경로 유지). */
#undef USE_PC_TEST_UART1_SLAVE
#define USE_PC_TEST_UART1_SLAVE  0
#undef ENABLE_PC_TEST_AA_STREAM
#define ENABLE_PC_TEST_AA_STREAM  0
#undef SYSTEM_CONFIG_BOOT_LOG
#define SYSTEM_CONFIG_BOOT_LOG  0   /* CFG[A]… 부팅 줄 반복·UART 혼선 방지 */
#endif
