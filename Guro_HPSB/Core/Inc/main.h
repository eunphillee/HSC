...
/* Private defines -----------------------------------------------------------*/
#define RLY_EN01_Pin GPIO_PIN_0
#define RLY_EN01_GPIO_Port GPIOA
#define RLY_EN02_Pin GPIO_PIN_1
#define RLY_EN02_GPIO_Port GPIOA
#define RLY_EN03_Pin GPIO_PIN_2
#define RLY_EN03_GPIO_Port GPIOA
#define TC_ADC01_Pin GPIO_PIN_3
#define TC_ADC01_GPIO_Port GPIOA
#define TC_ADC02_Pin GPIO_PIN_4
#define TC_ADC02_GPIO_Port GPIOA
#define TC_ADC03_Pin GPIO_PIN_5
#define TC_ADC03_GPIO_Port GPIOA
